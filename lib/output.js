...
var Output = /** @class */ (function () {
     ...
     */
    function Output(output_data, file) {
    ...
    Output.prototype.write = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this._file === null)) return [3 /*break*/, 1];
                        this.writeToStdout();
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.writeToFile()];
                    case 2:
                        _a.sent();
                        _a.label = 3;
     ...
     * write to stdout
     */
    Output.prototype.writeToStdout = function () {
     ...
     * @returns {Promise<void>}
     */
    Output.prototype.writeToFile = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, writeFileAsync(this._file, this._output_data, null)];
            });
        });
    };
    return Output;
