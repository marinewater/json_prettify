...
describe('Output', function () {
    describe('file', function () {
        ...
        it('should write output to a file', function () {
            return __awaiter(this, void 0, void 0, function () {
                var output, file_content;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            output = new output_1.Output('{"test": "case"}', 'test.json');
                            return [4 /*yield*/, output.write()];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, readFileAsync('test.json')];
                        case 2:
    ...
    describe('stdout', function () {
        beforeEach(function () { return stdMocks.use(); });
        afterEach(function () { return stdMocks.restore(); });
        it('should write to stdout', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            output = new output_1.Output('{"test": "case"}');
                            return [4 /*yield*/, output.write()];
                        case 1:
                            _a.sent();
